...
class AppColors{
  ...
  static final Color mainColor =const Color.fromARGB(255, 204, 50, 201);

  static final Color inconColor1 =const Color.fromARGB(255, 185, 35, 35);
  static final Color inconColor2 =const Color.fromARGB(255, 237, 171, 209);
